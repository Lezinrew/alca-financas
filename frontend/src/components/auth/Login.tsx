          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <Button
                type="button"
                size="lg"
                className="w-full bg-white hover:bg-gray-50 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-900 dark:text-slate-100 border-2 border-slate-200 dark:border-slate-700 shadow-md hover:shadow-lg transition-all duration-200 font-medium"
