          ...
          return (
            <li key={cat.category_id} className="p-4 space-y-3">
              ...
              <dl className="grid grid-cols-3 gap-2 text-sm">
                <div>
                  <dt className="text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400">Meta</dt>
                  <dd className="font-medium text-slate-900 dark:text-white">{formatCurrency(cat.planned_amount)}</dd>
                </div>
                <div>
                  <dt className="text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400">Recebido</dt>
                  <dd className="font-medium text-slate-900 dark:text-white">{formatCurrency(cat.received_amount)}</dd>
                </div>
                <div>
                  <dt className="text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400">Diferença</dt>
                  <dd className="font-medium text-slate-900 dark:text-white">{formatCurrency(cat.difference_amount)}</dd>
                </div>
              </dl>
              <div className="flex items-center gap-2">
