...
--   4) 20260416000004_categories_transactions_rls_tenant_membership.sql
-- =============================================================================
...
--    Esperado: *_tenant_policy_{select,insert,update,delete} em accounts,
--    categories, transactions (membership via tenant_members; sem JWT tenant_id)
SELECT schemaname, tablename, policyname, roles, cmd
FROM pg_policies
WHERE schemaname = 'public'
  AND tablename IN ('users', 'tenant_members', 'tenants', 'accounts', 'categories', 'transactions')
